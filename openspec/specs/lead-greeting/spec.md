# lead-greeting Specification

## Purpose
Defines the lead agent's greeting behavior when starting an interactive session, ensuring the user immediately understands the lead's role, capabilities, and actionable next steps grounded in repo state.
